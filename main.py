...
parser.add_argument('--nv_dim', type=int, default=16, help="dimension of varying factor latent space")
parser.add_argument('--nc_dim', type=int, default=16, help="dimension of common factor latent space")
...
parser.add_argument('--train_discriminator', type=bool, default=True, help="flag for discriminator training")
parser.add_argument('--train_generator', type=bool, default=True, help="flag for generator training")
...
parser.add_argument('--gen_coef', type=float, default=1., help="coefficient for the adversarial loss term")
parser.add_argument('--disc_coef', type=float, default=1., help="coefficient for the adversarial loss term")
parser.add_argument('--decorr_coef', type=float, default=1., help="coefficient for decorrelation loss term")
